...
export const DRINK_BRANDS: DrinkBrand[] = [
  ...
  // ── Coffee ──
  {
    name: 'Starbucks', category: 'coffee', products: [
      { name: 'Hot Coffee', flavors: ['Pike Place', 'Blonde Roast', 'Dark Roast', 'Decaf Pike Place', 'Featured Dark Roast', 'Clover Brewed'] },
      { name: 'Hot Latte', flavors: ['Caffè Latte', 'Vanilla Latte', 'Caramel Brulée Latte', 'Pumpkin Spice Latte', 'Chestnut Praline Latte', 'Oatmilk Latte', 'Blonde Vanilla Latte', 'Cinnamon Dolce Latte', 'Honey Oatmilk Latte'] },
      { name: 'Hot Mocha', flavors: ['Caffè Mocha', 'White Chocolate Mocha', 'Peppermint Mocha', 'Hot Chocolate'] },
      { name: 'Hot Macchiato', flavors: ['Caramel Macchiato', 'Apple Crisp Macchiato', 'Espresso Macchiato'] },
      { name: 'Hot Espresso', flavors: ['Espresso', 'Espresso Con Panna', 'Flat White', 'Americano', 'Cappuccino', 'Cortado'] },
      { name: 'Hot Tea', flavors: ['Chai Tea Latte', 'Matcha Tea Latte', 'London Fog', 'Jade Citrus Mint', 'Emperor\'s Clouds & Mist', 'Mint Majesty', 'Peach Tranquility', 'Royal English Breakfast', 'Earl Grey'] },
      { name: 'Iced Coffee', flavors: ['Iced Coffee', 'Iced Coffee with Milk', 'Iced Vanilla', 'Iced Caramel', 'Iced Hazelnut'] },
      { name: 'Iced Latte', flavors: ['Iced Caffè Latte', 'Iced Vanilla Latte', 'Iced Brown Sugar Oatmilk Shaken Espresso', 'Iced Cinnamon Dolce Latte', 'Iced Blonde Vanilla Latte', 'Iced Honey Oatmilk Latte', 'Iced Pumpkin Spice Latte', 'Iced Caramel Brulée Latte', 'Iced Chestnut Praline Latte'] },
      { name: 'Iced Mocha', flavors: ['Iced Caffè Mocha', 'Iced White Chocolate Mocha', 'Iced Peppermint Mocha'] },
      { name: 'Iced Macchiato', flavors: ['Iced Caramel Macchiato', 'Iced Apple Crisp Macchiato'] },
  ...
  },
  {
    name: 'Dunkin', category: 'coffee', products: [
      { name: 'Hot Coffee', flavors: ['Original Blend', 'Dunkin\' Midnight', 'Dunkin\' Decaf', 'French Vanilla', 'Caramel', 'Hazelnut', 'Mocha', 'Toasted Almond', 'Blueberry', 'Coconut'] },
      { name: 'Hot Latte', flavors: ['Latte', 'Vanilla Latte', 'Caramel Latte', 'Mocha Latte', 'Caramel Craze Signature Latte', 'Cocoa Mocha Signature Latte', 'Pumpkin Spice Signature Latte', 'Cookie Butter Cold Foam Latte'] },
      { name: 'Hot Macchiato', flavors: ['Caramel Macchiato', 'Mocha Macchiato'] },
      { name: 'Hot Cappuccino', flavors: ['Cappuccino', 'French Vanilla Cappuccino', 'Caramel Cappuccino', 'Mocha Cappuccino'] },
      { name: 'Americano', flavors: ['Hot Americano', 'Iced Americano'] },
      { name: 'Espresso', flavors: ['Espresso', 'Espresso with Milk'] },
      { name: 'Hot Tea', flavors: ['Bold Breakfast Black', 'Harmony Leaf Green', 'Cool Mint Herbal', 'Chamomile Fields Herbal', 'Hibiscus Kiss Herbal'] },
      { name: 'Hot Chai', flavors: ['Vanilla Chai', 'Chai Latte'] },
      { name: 'Hot Matcha', flavors: ['Matcha Latte'] },
      { name: 'Hot Chocolate', flavors: ['Hot Chocolate', 'Mint Hot Chocolate'] },
      { name: 'Iced Coffee', flavors: ['Iced Coffee', 'French Vanilla Iced', 'Caramel Iced', 'Mocha Iced', 'Hazelnut Iced', 'Toasted Almond Iced', 'Blueberry Iced', 'Coconut Iced'] },
      { name: 'Iced Latte', flavors: ['Iced Latte', 'Iced Vanilla Latte', 'Iced Caramel Latte', 'Iced Mocha Latte', 'Brown Sugar Cookie Iced Latte', 'Pumpkin Spice Iced Latte'] },
      { name: 'Cold Brew', flavors: ['Cold Brew', 'Vanilla Cold Brew', 'Caramel Cold Brew', 'Chocolate Stout Cold Brew', 'Charli Cold Foam'] },
