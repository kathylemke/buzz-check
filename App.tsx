...
function AppTabs() {
  ...
  return (
    ...
    >
      <Tab.Screen name="Feed" component={FeedScreen} options={{ tabBarIcon: ({ color }) => <RNText style={{ fontSize: 22, color }}>⚡</RNText> }} />
      <Tab.Screen name="Post" component={NewPostScreen} options={{ tabBarIcon: ({ color }) => <RNText style={{ fontSize: 22, color }}>➕</RNText> }} />
      <Tab.Screen name="Board" component={LeaderboardScreen} options={{ tabBarIcon: ({ color }) => <RNText style={{ fontSize: 22, color }}>🏆</RNText> }} />
      <Tab.Screen name="Map" component={MapScreen} options={{ tabBarIcon: ({ color }) => <RNText style={{ fontSize: 22, color }}>🗺️</RNText> }} />
      <Tab.Screen name="Profile" component={ProfileScreen} options={{ tabBarIcon: ({ color }) => <RNText style={{ fontSize: 22, color }}>👤</RNText> }} />
    </Tab.Navigator>
  );
}
